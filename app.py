...
#         EXPECTED_COLUMNS = ['PM2.5', 'PM10', 'NO2', 'Humidity', 'Temperature']

#         # Align DataFrame columns with the expected order
#         missing_columns = set(EXPECTED_COLUMNS) - set(data.columns)
#         if missing_columns:
#             return jsonify({"error": f"Missing columns: {', '.join(missing_columns)}"}), 400

#         X = data.reindex(columns=EXPECTED_COLUMNS)

#         # Handle missing data (if required, fill missing values with default values like 0)
